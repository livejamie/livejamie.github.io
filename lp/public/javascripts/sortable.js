//From: https://github.com/yields/sortable/
//Added: drag handles, 
...
Sortable.prototype.bind = function(e){
  ...
  $(this.clone).addClass('sortable-placeholder');
  return this;
};


Sortable.prototype.mousedown = function (){
  this.handleBlocked = false;
}

Sortable.prototype.mouseup = function (){
